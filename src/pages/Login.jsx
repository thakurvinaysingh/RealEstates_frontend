...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await login(formData.email, formData.password); // ✅ API call via AuthContext
...
//               type="submit"
//               disabled={isLoading}
//               className="w-full rounded-lg bg-purple-600 hover:bg-purple-600 text-white py-3 text-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
//             >
//               {isLoading ? (
//                 <div className="flex items-center justify-center">
//                   <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white mr-2"></div>
